...
def distance_per_track(minutes, seconds, asphalt_field_time, asphalt_forest_time, dirt_field_time, dirt_forest_time, total_time):
    ...
    forest_track_ratio = round((dirt_forest_distance+asphalt_forest_distance)/total_distance,2)

    return asphalt_field_distance, asphalt_forest_distance, dirt_field_distance, dirt_forest_distance, total_distance, asphalt_track_ratio, forest_track_ratio


def output(minutes_seconds, asphalt_field_time, asphalt_forest_time, dirt_field_time, dirt_forest_time, total_time, asphalt_field_distance, asphalt_forest_distance, dirt_field_distance, dirt_forest_distance, total_distance, asphalt_track_ratio, forest_track_ratio):

    print('\x1b[6;30;42m' + 'Congratulations! Your activity has been tracked. Well done!' + '\x1b[0m')
    tt = PrettyTable(['', 'Total Time (in min)', 'Total Distance (in km)', 'Pace', 'Asphalt Track Ratio', 'Forest Track Ratio'])
    tt.add_row(['Total', total_time, total_distance, minutes_seconds, asphalt_track_ratio, forest_track_ratio])
    print(tt)
...
def append_running_summary(asphalt_forest_time, asphalt_forest_distance, asphalt_field_time, asphalt_field_distance, dirt_field_time, dirt_field_distance, dirt_forest_time, dirt_forest_distance, total_time, total_distance, minutes, seconds, date, minutes_seconds, asphalt_track_ratio, forest_track_ratio):
    add =[date, total_time, total_distance, minutes_seconds, asphalt_track_ratio, forest_track_ratio, asphalt_forest_time, asphalt_forest_distance, asphalt_field_time, asphalt_field_distance, dirt_field_time, dirt_field_distance, dirt_forest_time, dirt_forest_distance]
