...
if __name__ == "__main__":
    ...
    asphalt_field_distance, asphalt_forest_distance, dirt_field_distance, dirt_forest_distance, total_distance, asphalt_track_ratio, field_track_ratio = distance_per_track(minutes, seconds, asphalt_field_time, asphalt_forest_time, dirt_field_time, dirt_forest_time, total_time)
    output(minutes_seconds, asphalt_field_time, asphalt_forest_time, dirt_field_time, dirt_forest_time, total_time, asphalt_field_distance, asphalt_forest_distance, dirt_field_distance, dirt_forest_distance, total_distance, asphalt_track_ratio, field_track_ratio)
    create_csv()
    append_running_summary(asphalt_forest_time, asphalt_forest_distance, asphalt_field_time, asphalt_field_distance, dirt_field_time, dirt_field_distance, dirt_forest_time, dirt_forest_distance, total_time, total_distance, minutes, seconds, date, minutes_seconds, asphalt_track_ratio, field_track_ratio)
